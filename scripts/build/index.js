...
/***/ ((__unused_webpack_module, exports, __nccwpck_require__) => {
        ...
        var propertyExpr = __nccwpck_require__(267);
        var tinyCase = __nccwpck_require__(265);
        var toposort = __nccwpck_require__(84);
...
/***/ ((__unused_webpack_module, exports, __nccwpck_require__) => {
        ...
        const yup_1 = __nccwpck_require__(430);
        const fs_util_1 = __nccwpck_require__(535);
        const metaSchema = (0, yup_1.object)({
        ...
        const validateMeta = async (path) => {
          try {
            const fileContents = await (0, fs_util_1.readFile)(path);
